    ...
    public class HomeController : Controller
    {
        ...
        public async Task<IActionResult> Create(Product model, IFormFile imageFile)
        {
            ...
            if (imageFile != null)
            {
                ...
                {
                    ModelState.AddModelError("imageFile", "Lütfen .jpg, .jpeg veya .png uzantýlý dosya yükleyiniz.");
                }
            }
            ...
            if (ModelState.IsValid)
            {
                if (imageFile != null)
                {
                    ...
                    using (var stream = new FileStream(path, FileMode.Create)) // dosya yükleme iþlemi
                    {
